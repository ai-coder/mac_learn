...
""" loading data from matlab file where datas are stored in form of dictionary. You can use data.keys() to get the list of the keys in the dictionary."""

data = loadmat('datas/data3_1.mat')

"""The shape of X wnd y will be 5000 x 401 and 5000 x 1 repectively after the following line of assignment.  The X and y used here are keys of the dictionary format data stored in the matlab file"""
